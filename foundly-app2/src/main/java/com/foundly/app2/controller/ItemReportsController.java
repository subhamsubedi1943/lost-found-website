...
public class ItemReportsController {
  ...
  //backend-fetch  
 // ItemReportsController.java

    @GetMapping("/my-activity")
    public ResponseEntity<List<ItemReports>> getMyActivity(@RequestParam Integer userId) {
        List<ItemReports> myActivity = itemReportsService.getMyActivity(userId);
